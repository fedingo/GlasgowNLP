...
class MusicBertRegressor(nn.Module):
    ...
    def __init__(self, sound_dim, out_dim,
                 hidden_dims = 128, **kwargs):
        super(MusicBertRegressor, self).__init__()
        
        self.BERT = MusicBertConvs(dim_sound = sound_dim, name = "music_bert_regression", **kwargs)
