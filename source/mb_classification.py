...
from .utils import generator_repeat
from tqdm.notebook import tqdm

class MusicBertClassifier(nn.Module):

    def __init__(self, sound_dim, n_class,
                 hidden_dims = 128, multi_label=False, **kwargs):
        super(MusicBertClassifier, self).__init__()
        
        self.BERT = MusicBertConvs(dim_sound = sound_dim, name = "music_bert_classification", **kwargs)
